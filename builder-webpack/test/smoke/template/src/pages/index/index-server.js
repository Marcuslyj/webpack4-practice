...
require('../../../styles/reset/reset.css');
require('./index.less');
const largeNumber = require('lyj-large-number');
const img1 = require('../../assert/img/微信图片_20190627183624.jpg');
const img2 = require('../../assert/img/if_Halloween-06_355959.png');
// import echarts from 'echarts'
